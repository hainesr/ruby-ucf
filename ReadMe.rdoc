...
this API into closer alignment with the
underlying zip-container API (ZipContainer::File).

UCF::Container will be available until version 1.0.0 when it will be
removed.
