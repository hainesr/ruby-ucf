...
{nokogiri gem}[https://github.com/sparklemotion/nokogiri] is available then
this library will use it to validate the contents of the
<tt>container.xml</tt> file. This functionality is not enforced on the user in
...
* Validation of all file contents in the META-INF directory. The
  <tt>container.xml</tt> file is validated but others are not yet.
